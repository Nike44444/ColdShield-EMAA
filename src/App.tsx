      ...
      <div className="relative mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <a href="https://cold-chain-shield.preview.emergentagent.com/" target="_blank" rel="noreferrer" className="rounded-xl border border-cyan-700/50 bg-cyan-950/40 px-3 py-2 text-xs font-semibold text-cyan-200 hover:bg-cyan-900/50">Further vaccine details ↗</a>
