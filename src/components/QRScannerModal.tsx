  ...
  useEffect(() => {
    ...
    const start = async () => {
      try {
        ...
        if (!Detector) { setStatus('unsupported'); setMessage('Camera is ready. This browser cannot decode QR automatically; enter the batch code below.'); return; }
